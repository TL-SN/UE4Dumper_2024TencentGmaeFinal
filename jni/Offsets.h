...
namespace Offsets {
    ...
    void initOffsets_32() {
        ...
        //Class: UObject
        UObjectToInternalIndex = 0x8;               // 0x8==0x8
        UObjectToClassPrivate = 0xC;                // 0xc => 0x14
        UObjectToFNameIndex = 0x10;                 // 0x10 => 0x18
        UObjectToOuterPrivate = 0x18;               // 0x18 => 0x20
        //Class: UField
        UFieldToNext = 0x1C;                    // 0x1c => 0x2c
        //Class: UStruct
        UStructToSuperStruct = 0x20;                // 有patch
        UStructToChildren = 0x24;                   // 有patch
        //Class: UFunction
        ...
        //Class: UWorld
        UWorldToPersistentLevel = 0x20;             // 0x20 => 0x58 
        //Class: Offsets::FNameStride
        ULevelToAActors = 0x70;                     // 0x70 => 0x9c
        ULevelToAActorsCount = 0x74;                // 0x74 => 0xa4
    } 
    ...
    void patchUE423_32() {              // UE423_UE425 与 isUE425会调用这个
        //Class: FNamePool
        FNameStride = 0x2;
        ...
        //Class: UStruct
        UStructToSuperStruct = 0x28;        // 0x28 => 0x40 
        UStructToChildren = 0x2c;           // 0x2c => 0x6c
        //Class: UFunction
        //UE4.24 - 4.25（待修改）
        UFunctionToFunctionFlags = 0x60;
        UFunctionToFunc = 0x7c;
    ...
    void patchUE425_32(){                           // ue4.25以上还会单独调用这个    
        //Class: UStruct
        UStructToChildProperties = 0x30;            // ChildProperties: 0x30 ==> 0x44/0x5c   
        //Class: UFunction
        //ue4.26 (32): UFunctionToFunctionFlags = 0x6c; UFunctionToFunc = 0x88;
        UFunctionToFunctionFlags = 0x6c;    // 0x6c => 0x84
        UFunctionToFunc = 0x88;         // 0x88 => 0xa4
    ...
    void initOffsets_64() {
        ...
        UFieldToNext = 0x28;
        //Class: UStruct
        UStructToSuperStruct = 0x30;                // SuperStruct: 0x28 ==> 0x40 
        UStructToChildren = 0x38;                   // Children: 0x2c  ==> 0x6c
        //Class: UFunction
    ...
    void patchUE423_64() {                  // isUE423_UE425 || isUE425
        //Class: FNamePool
        FNameStride = 0x2;
